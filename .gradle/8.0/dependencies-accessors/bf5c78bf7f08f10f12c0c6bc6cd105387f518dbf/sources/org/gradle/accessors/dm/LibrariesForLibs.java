...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class FirebaseLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public FirebaseStorageLibraryAccessors getStorage() { return laccForFirebaseStorageLibraryAccessors; }
    ...
    public static class FirebaseStorageLibraryAccessors extends SubDependencyFactory {
        ...
        public FirebaseStorageLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getKtx() { return create("firebase.storage.ktx"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: material (1.6.0-alpha08)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
         ...
         */
        public DatastoreVersionAccessors getDatastore() { return vaccForDatastoreVersionAccessors; }
    ...
    public static class FirebaseVersionAccessors extends VersionFactory  {
         ...
         */
        public FirebaseAuthVersionAccessors getAuth() { return vaccForFirebaseAuthVersionAccessors; }
         ...
         */
        public FirebaseFirestoreVersionAccessors getFirestore() { return vaccForFirebaseFirestoreVersionAccessors; }

        /**
         * Returns the group of versions at versions.firebase.storage
         */
        public FirebaseStorageVersionAccessors getStorage() { return vaccForFirebaseStorageVersionAccessors; }
    ...
    public static class FirebaseAuthVersionAccessors extends VersionFactory  {
        ...
        public FirebaseAuthVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: firebase.auth.ktx (22.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class FirebaseCrashlyticsVersionAccessors extends VersionFactory  {
        ...
        public FirebaseCrashlyticsVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: firebase.crashlytics.ktx (18.5.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class FirebaseFirestoreVersionAccessors extends VersionFactory  {
        ...
        public FirebaseFirestoreVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: firebase.firestore.ktx (24.9.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class FirebaseStorageVersionAccessors extends VersionFactory  {
        ...
        public FirebaseStorageVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: firebase.storage.ktx (20.3.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class LottieVersionAccessors extends VersionFactory  {
        ...
        public LottieVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: lottie.compose (4.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
